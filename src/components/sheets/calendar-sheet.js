        ...
        for (let day = 0; day < 7; day++) {
            ...
            user.calendarActivity.forEach((measure) => {
                for (let i = 0; i < calendar.weeks.length - 1; i++) {
                    if (measure.dateObj >= Date.parse(calendar.weeks[i].date) &&
...
//# sourceMappingURL=calendar-sheet.js.map